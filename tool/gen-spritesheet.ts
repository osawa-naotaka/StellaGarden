...
const src = ["tileset", "Idle", "Dash", "Jump", "walk", "icons-items", "BirchTree", "SpringCrops", "TilesetGrassWaterSpring", "TilesetGrassCliffTilesetSpring", "TilesetGrassSpring", "TilledSoilAndWetSoil"];
