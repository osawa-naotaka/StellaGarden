...
export const ENTITY_NAMES: Record<number, string> = {
    ...
    [ENTITY_TYPES.bonfire_lit]: "焚き火（点火中）",
    [ENTITY_TYPES.bonfire_done]: "焚き火（消火）",
    [ENTITY_TYPES.kiln_burning]: "炭焼き窯（点火中）",
    [ENTITY_TYPES.compost_bin_loaded]: "堆肥場（loaded）",
    [ENTITY_TYPES.compost_bin_fermenting]: "堆肥場(fermenting)",
    [ENTITY_TYPES.compost_bin_done]: "堆肥場(完了)",
    ...
    [ENTITY_TYPES.soaking_basket_loaded]: "浸漬槽(loaded)",
    [ENTITY_TYPES.soaking_basket_done]: "浸漬槽(完了)",
